...
public class ToDoList : MonoBehaviour
{
     ...
     * 1. Make the player controller by using the input system for movement and "Get Key" Functions for the abilities and the attacks. (DONE)
     ...
     * 6. Create Enemies by making a single class for demonstration on the skill set. (IN PROGRESS)
     * 7. Create UI that is based on the healing, cooldown, damage, health, etc.
     * 8. Add as many extra content as desired, also, ASK JEFF AND ZACH FOR HELP ON LITTLE DETAILS!!.
     */
}
